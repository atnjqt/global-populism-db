  ...
  return (
    <aside className="space-y-2">
      ...
      <button
        ...
        className="lg:hidden w-full bg-blue-600 text-white py-2.5 px-3 rounded-lg flex items-center justify-between shadow-md hover:bg-blue-700 transition-colors"
      >
        <span className="font-semibold text-sm">⚙️ Filters</span>
        <svg
      ...
      {/* Filters Card */}
      <div className={`${settingsExpanded ? 'block' : 'hidden'} lg:block bg-white rounded-lg shadow-md overflow-hidden`}>        {/* Year Range Section */}
        ...
        <div className="p-2 sm:p-3 lg:p-4 border-b border-gray-100">
          ...
          <div className="flex gap-1">
            <button
              ...
              className={`flex-1 py-1.5 sm:py-2 px-2 rounded-lg text-xs font-medium transition-all ${
                !colorByIdeology
        ...
        {/* Ideology Filter Section */}
        <div className="p-2 sm:p-3 lg:p-4 border-b border-gray-100">
          <h3 className="text-xs sm:text-sm font-semibold text-gray-700 uppercase tracking-wide mb-2">
            Ideology{ideology !== null ? `: ${ideology === -1 ? 'Left' : ideology === 0 ? 'Center' : 'Right'}` : ''}
          </h3>
          <div className="flex gap-1">
            {[
        ...
        <div className="p-2 sm:p-3 lg:p-4">
          ...
          <select
            ...
            className="w-full p-1.5 sm:p-2 border-2 border-gray-200 rounded-lg focus:border-primary-400 focus:outline-none text-xs sm:text-sm"
          >
